            ...
            timepicker
                ...
                .on('touchend mousedown.xdsoft', function () {
                    ...
                    (function arguments_callee4(v) {
                         ...
                         * The reason is that the transition-duration time, if you set it to 0, all things fine,
                         * otherwise, this would cause a bug when you use jquery.css method. Let's say: * { transition:
                         * all .5s ease; } jquery timebox.css('marginTop') will return the original value which is
                         * before you clicking the next/prev button, meanwhile the timebox[0].style.marginTop will
                         * return the right value which is after you clicking the next/prev button.
                         *
                         * What we should do:
                    ...
                    input.on('keydown.xdsoft', function (event) {
                        ...
                        if (((key >= KEY0 && key <= KEY9) ||
                            ...
                            if (hasSel) {
                                ...
                                // if we have a selection length we will wipe out entire selection and replace with
                                // default template for that range
                                var defaultBlank = options.mask.replace(/[0-9]/g, '_');
                                var defaultBlankSelectionReplacement = defaultBlank.substr(pos, selLength);
                                var selReplacementRemainder = defaultBlankSelectionReplacement.substr(1); // might be
                                                                                                         // empty
